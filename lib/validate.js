...
module.exports = {
  validate() {
    ...
    this.serverless.cli.log('validate() functions array');
    this.serverless.cli.log(JSON.stringify(functions, null, 2));


    this.serverless.cli.log('validate() forEach(functions) ------------>');
    ...
    if (this.options.function) {
      ...
      _.forEach(functions, (func, index) => {
        ...
        this.serverless.cli.log('loadedFunc:');
        this.serverless.cli.log(JSON.stringify(loadedFunc, null, 2));
    ...
    this.serverless.cli.log('validate() forEach end <------------');
    ...
    this.serverless.cli.log('lib.entries:');
    this.serverless.cli.log(JSON.stringify(lib.entries, null, 2));
    ...
    const processConfig = _config => {
      this.serverless.cli.log('processConfig config entry:');
      this.serverless.cli.log(JSON.stringify(_config, null, 2));
      ...
      this.serverless.cli.log('processConfig this.webpackConfig return:');
      this.serverless.cli.log(JSON.stringify(this.webpackConfig, null, 2));
